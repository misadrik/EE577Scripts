def log_printer(Instr_split, machine_code, fout):
    ...
    print('*******************MEM*******************',file = fout)
    print('MEM_WRITE|LWI = ', machine_code[15:17], file=fout)
    print('*******************WB*******************', file=fout)
    print('WRITE_REG|REG_WRITE = ', machine_code[17], machine_code[18], file=fout)
    print('DATA2REG         = ', machine_code[19], file=fout)
    print('',file = fout)
    print('',file = fout)
