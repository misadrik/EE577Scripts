def print_vec(machine_code, fout):
    ...
    print('4444 4444 3 3 1 3 1 1 1 3 1 2', file=fout)

    print('io', end=' ', file=fout)
    print('i i i i i i i i i i i i', file=fout)
    ...
    for num, each in enumerate(machine_code):
        ...
        print(each[15], end='    ', file=fout) #MEM_WRITE +1
        print(each[16], end='   ', file=fout) #LWI +1
        print(each[17], end='    ', file=fout) #WR_REG +1
        print(each[18], end='    ', file=fout) #REG_WRITE +1
        print(each[19], end='   ', file=fout) #DATA2REG +1
        print('', file = fout)
